...
const ForecastReportTableHeader = () => {
  const { t } = useTranslation();
  return (
    <View style={styles.tableHeader}>
      {/* Row 2 */}
      <View style={styles.tableHeaderRow}>
        <Text style={styles.projectCell}>{`\n${t('report.forecastReport.projectNameTitle')}`}</Text>
        <Text style={styles.projectManagerCell}>{`${t('report.forecastReport.projectsTitle')}\n${t('report.forecastReport.projectManagerTitle')}`}</Text>
...
export default memo(ForecastReportTableHeader);