...
interface IProjectCardDeleteNoteFormProps {
  isOpen: boolean;
  noteId: string;
  close: () => void;
}

const ProjectCardDeleteNoteForm: FC<IProjectCardDeleteNoteFormProps> = ({
  isOpen,
  close,
  noteId,
}) => {
...
export default memo(ProjectCardDeleteNoteForm);
